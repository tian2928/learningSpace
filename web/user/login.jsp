...
font {
 ...
 <script type="text/javascript">
 	function chageImg(img){
 		img.src = "${pageContext.request.contextPath }/userServlet?method=code&time="+new Date().getTime();
 	}
 </script>
</head>
<body>
...
<form class="form-horizontal" action="${pageContext.request.contextPath }/userServlet" method="post">
 ...
 <div class="form-group">
   ...
   <div class="form-group">
    ...
    <div class="col-sm-3">
      <input type="text" name="code" class="form-control" id="inputPassword3" placeholder="请输入验证码">
    </div>
    <div class="col-sm-3">
      <img  src="${pageContext.request.contextPath }/userServlet?method=code" onclick="chageImg(this)"/>
    </div>
