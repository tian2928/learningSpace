...
<%@ include file="header.jsp" %>
		<div class="container">
			...
			<div>
				<hr/>
				<form id="orderForm" action="${pageContext.request.contextPath }/payServlet" method="post" class="form-horizontal" style="margin-top:5px;margin-left:150px;">
				...
				<div style="margin-top:5px;margin-left:150px;">
					...
					<p>
						...
						<img src="./bank_img/cmbc.bmp" align="middle" />
